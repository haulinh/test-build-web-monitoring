...
export default class CameraList extends React.Component {
  ...
  async componentDidMount() {
    ...
    this.setState({ cameraList, cameraListNotUnicode})
  }
  ...
  searchResult = (cameraListNotUnicode, searchString) => {
    return _.filter(cameraListNotUnicode, item => {
      ...
      const isMatchSearch = regex.test(item.name) || regex.test(item.stationName)
  ...
  renderSearch = () => {
    return <Input.Search placeholder="search camera" onChange={this.saveSearchString} />
  }
