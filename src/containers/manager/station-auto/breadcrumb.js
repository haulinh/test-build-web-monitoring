...
export default createBreadcrumb({
  ...
  config: {
    ...
    name: translate('stationAutoManager.configConnect.title'),
  },
  configNotification: {
    id: 'configNotification',
    //icon: Icon.car,
    href: slug.stationAuto.configSendNotification.base,
    name: translate('stationAutoManager.configNotification.title'),
  },
  configSampling: {
    id: 'configSampling',
    //icon: Icon.car,
    href: slug.stationAuto.configSampling.base,
    name: translate('stationAutoManager.sampling.title'),
  },
  configCamera: {
    id: 'configCamera',
    //icon: Icon.car,
    href: slug.stationAuto.configCamera.base,
    name: translate('stationAutoManager.camera.title'),
  },
  configColor: {
    id: 'configColor',
    //icon: Icon.car,
