...
const IMPORT_DATA_ERROR = {
  ...
  ALARM_LEVEL_I_INVALID: 'ALARM_LEVEL_I_INVALID',
  ALARM_LEVEL_II_INVALID: 'ALARM_LEVEL_II_INVALID',
  ALARM_LEVEL_III_INVALID: 'ALARM_LEVEL_III_INVALID',
  DATE_INVALID: 'DATE_INVALID',
  HOUR_INVALID: 'HOUR_INVALID',
  MEASURE_VALUE_INVALID: 'MEASURE_VALUE_INVALID',
  DATA_TYPE_INVALID: 'DATA_TYPE_INVALID',
  DATA_SOURCE_INVALID: 'DATA_SOURCE_INVALID',
  BROADCAST_TIME_INVALID: 'BROADCAST_TIME_INVALID',
  BROADCAST_DATE_INVALID: 'BROADCAST_DATE_INVALID',
  REAL_DATA_INVALID: 'REAL_DATA_INVALID',
  INVALID_DAY_DATA_NUMBER: 'INVALID_DAY_DATA_NUMBER',
  FORECAST_DATA_INVALID: 'FORECAST_DATA_INVALID',
}
