...
const IMPORT_DATA_ERROR = {
  ...
  MEASURE_VALUE_INVALID: 'Mực nước không hợp lệ',
  ...
  BROADCAST_DATE_INVALID: 'Ngày phát bản tin không hợp lệ',
  REAL_DATA_INVALID: 'Dữ liệu thực tế không hợp lệ',
  INVALID_DAY_DATA_NUMBER: 'Số dữ liệu ngày không hợp lệ',
  FORECAST_DATA_INVALID: 'Dự báo dữ liệu không hợp lệ',
}
