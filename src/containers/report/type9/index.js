...
import {getUrlReportType8} from 'api/DataStationAutoApi'
...
export default class ReportType1 extends React.Component {
  ...
  handleSubmit(values){
    ...
    let url = getUrlReportType8(this.props.token, values.stationAuto, values.time.format("MM-YYYY"), measuringListStr, measuringListUnitStr)
    console.log('getUrlReportType8', url)
