...
import {getUrlReportType3} from 'api/DataStationAutoApi'
...
export default class ReportType1 extends React.Component {
  ...
  handleSubmit(values){
    ...
    let url = getUrlReportType3(this.props.token, values.stationAuto, values.time.format("MM-YYYY"), measuringListStr, measuringListUnitStr)
    console.log('getUrlReportType3', url)
