...
import QuizListIcon from '@atlaskit/icon/glyph/editor/bullet-list'
import ImageIcon from '@atlaskit/icon/glyph/image'
import LocationIcon from '@atlaskit/icon/glyph/location'
import ScreenIcon from '@atlaskit/icon/glyph/vid-share-screen'
import DashboardIcon from '@atlaskit/icon/glyph/dashboard'
import GraphBarIcon from '@atlaskit/icon/glyph/graph-bar'
import GraphLineIcon from '@atlaskit/icon/glyph/graph-line'
import BookIcon from '@atlaskit/icon/glyph/book'
import StationFixed from '@atlaskit/icon/glyph/tray'
import HipchatIcon from '@atlaskit/icon/glyph/star'
...
import WQIIcon from '@atlaskit/icon/glyph/ship'
