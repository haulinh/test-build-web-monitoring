...
const DEVICE_STATUS = {
  "0": { src: "/images/sensor/good.png", text: "monitoring.deviceStatus.normal" },
  "1": {
    src: "/images/sensor/maintain.png",
    text: "monitoring.deviceStatus.maintenance"
  },
  "2": { src: "/images/sensor/error.png", text: "monitoring.deviceStatus.broken" }
};
...
class TableData extends React.Component {
  ...
  khoiTaoColumn() {
    ...
    tampColumnMeasure = tampColumnMeasure.filter(item => {
      return (
        this.props.measureShow && this.props.measureShow.includes(item.key)
      );
    });
