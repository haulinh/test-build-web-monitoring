export default function setUp() {
  ...
  MarkerLabel_.prototype.onAdd = function() {
    ...
    var position_changed =
      this.marker_.ghostAnimationPosition !== undefined
        ? 'ghostanimationposition_changed'
        : this.marker_.animationPosition !== undefined
  ...
  MarkerLabel_.prototype.setPosition = function(yOffset) {
    var getPosition =
      this.marker_.getGhostAnimationPosition ||
      this.marker_.getAnimationPosition ||
      this.marker_.getPosition
    var position = this.getProjection().fromLatLngToDivPixel(
      getPosition.call(this.marker_)
    )
