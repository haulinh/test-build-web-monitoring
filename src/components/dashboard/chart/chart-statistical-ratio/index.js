    ...
    return (
      <WrapperView>
        <Card bordered style={{flex: 1, marginRight: 8}}>
          <ReactHighcharts config={config('Tỉ lệ nhận dữ liệu theo từng địa phương theo tháng' ,['Nhận được' ,'Không nhận được'])}
          />
        </Card>
        <Card bordered style={{flex: 1, marginLeft: 8}}>
          <ReactHighcharts config={config('Tình trạng hoạt động của trạm', ['Hoạt động' ,'Không hoạt động'], 'bar')}
          />
        </Card>
      </WrapperView>
    )
