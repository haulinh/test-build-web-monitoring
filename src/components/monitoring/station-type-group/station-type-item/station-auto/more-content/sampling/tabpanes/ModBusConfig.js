                ...
                <ConfigModBusWrapper>
                    <FormItem>
                        {getFieldDecorator('modbusTcpAddr', {
                            ...
                            <Input addonBefore="tcp://" placeholder="nhap dia chi data-logger" />
                        )}
                    </FormItem>
                    ...
                    <FormItem>
                        {getFieldDecorator('coilAddr', {
                            ...
                            <Input addonBefore="Địa chỉ coil:" placeholder="Nhap dia chi coil" />
                        )}
                    </FormItem>
                    ...
                    <FormItem>
                        {getFieldDecorator('totalBottles', {
                            ...
                            <Input addonBefore="Tổng số chai" placeholder="Tong so chai cua may lay mau" />
                        )}
                    </FormItem>
