...
export default {
  ...
  stationFixedPhase: {
    base: '/station-fixed-phase',
    list: '/station-fixed-phase',
    create: '/station-fixed-phase/create',
  ...
  advance: {
    ...
    wqi_periodic: '/advance/wqi-periodic',
    mapWqi: '/advance/wqi',
...
export const MENU_NAME = {
  ...
  stationFixedSub: translate('menuApp.stationFixedSub'),
  stationFixed: {
  ...
  advance: {
    ...
    wqiPeriodic: translate('menuApp.advance.wqiPeriodic'),
...
export const TOOLTIP_MENU = {
  ...
  advance: {
    ...
    wqiPeriodic: translate('tooltipMenuApp.advance.wqiPeriodic'),
