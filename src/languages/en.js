export default {
  ...
  monitoring: {
    ...
    deviceStatus: {
      ...
      maintenance: 'The device is in calibration progress',
      sensorNormal: 'The device is in normal state now',
      normal: 'Normal',
      broken: 'Broken',
      good: 'The device is in normal state now',
    },
  ...
  warningLevels: {
    ...
    exceed: 'Exceeded',
    lossData: 'Data has not been transferred recently',
    sensorError: 'Device connected failure',
    collecting: 'Good',
    lostConnection: 'Data has not been transferred recently',
    overload: 'Overload',
  ...
  common: {
    ...
    deviceStatus: {
      ...
      dataGood: 'The device is in normal state now',
      dataGood2: 'Data Good Again',
      dataLoss: 'Data has not been transferred recently',
      dataConnected: 'The station has normal signal now',
    },
    overview: 'Overview',
    list: 'List',
    statusSensor: 'Sensor Status',
