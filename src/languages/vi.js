export default {
  ...
  monitoring: {
    ...
    deviceStatus: {
      ...
      maintenance: 'Thiết bị đang hiệu chuẩn',
      sensorNormal: 'thiết bị tốt trở lại.',
      normal: 'Đang đo',
      broken: 'Báo lỗi',
  ...
  warningLevels: {
    ...
    exceedPreparing: 'Đang chuẩn bị vượt ngưỡng',
    exceed: 'Vượt nguỡng',
    lossData: 'đang mất tín hiệu',
    sensorError: 'Thiết bị đang bị lỗi',
    collecting: 'Thiết bị tốt trở lại.',
  ...
  common: {
    ...
    deviceStatus: {
      ...
      dataExceededPrepare: 'Đang chuẩn bị vượt ngưỡng',
